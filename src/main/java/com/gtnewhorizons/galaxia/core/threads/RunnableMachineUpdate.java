...
public class RunnableMachineUpdate implements Runnable {
    ...
    private static final ThreadFactory THREAD_FACTORY = r -> {
        ...
        thread.setName("Galaxia_MachineBlockUpdate");
        return thread;
    };
    ...
    public static void shutdownExecutorService() {
        ...
        try {
            Galaxia.LOG.info("Shutting down Machine block update executor service");
            ...
            Galaxia.LOG.error("Well this interruption got interrupted...", ie);
            ...
            Galaxia.LOG.error("Well this didn't terminated well...", e);
            // (Re-)Cancel in case
            EXECUTOR_SERVICE.shutdownNow();
        } finally {
            Galaxia.LOG.info("Leaving... RunnableMachineUpdate.shutdownExecutorService");
